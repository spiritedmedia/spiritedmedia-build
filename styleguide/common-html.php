...
?>
    <div class="content-wrapper row">
		<main class="main columns large-8 js-main" role="main">
			<article class="c-content c-panel entity--article entity" data-author-count="1" data-author-role="staff" data-editorial-content="" data-entity="" data-post-type="article" data-primary-story="51480">
				<header class="c-content__header">
					<h2 class="c-content__title">Common HTML Markup</h2>
					<div class="c-content__excerpt">
						<p>It's the simple bits that make up our site.</p>
					</div>
				</header>
				<div class="c-panel__inner">
					<section class="c-content__body s-post-content">
...
nunc. Morbi imperdiet augue
 quis tellus.
					...
					<footer class="c-content__footer [ o-rule--closure o-rule ]"></footer>
			</article>
		</main>
