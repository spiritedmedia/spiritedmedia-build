...
class CLI_Command extends \WP_CLI_Command {
     ...
     *
     * https://github.com/spiritedmedia/pedestal/issues/1468
     */
    ...
    public function generate_config_file( $args, $assoc_args ) {
        ...
        foreach ( $sites as $site ) {
            ...
            $config['pedestal']['children'][ $current_theme ] = [
                ...
                'themePath'   => $wp_themes_path . '/' . $current_theme,
        ...
        file_put_contents( ABSPATH . '/config/config.json', json_encode( $config ) );
        ...
        file_put_contents( ABSPATH . '/config/config-sassy.json', json_encode( $sassy_config ) );
