...
class Frontend {
     ...
     *
     * @link https://github.com/spiritedmedia/pedestal/issues/1443
     */
    ...
    public function action_wp_enqueue_scripts() {
        ...
        wp_enqueue_style( $theme_name . '-styles', get_stylesheet_directory_uri() . '/assets/dist/css/' . $theme_name . '.css', [ 'google-fonts', 'soundcite' ], PEDESTAL_VERSION );
