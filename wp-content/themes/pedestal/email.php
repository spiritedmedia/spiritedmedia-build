...
add_filter( 'timber_context', function( $context ) {
    ...
    $context['datetime_format'] = sprintf( esc_html__( '%s \a\t %s', 'pedestal' ), get_option( 'date_format' ), get_option( 'time_format' ) );

    $context['styles'] = file_get_contents( get_template_directory() . '/assets/dist/css/email.css' );
